...
namespace
{
    ...
    void RunAddmmGeluMlpTest(const pi::tensorlib::DataType dtype)
    {
        ...
        const auto l1 = std::make_shared<pi::tensorlib::Linear>(
            "l1", 10, 5, device, dtype, pi::tensorlib::ActivationFunction::GELU, init_graph, rng_seed,
            main_stream_desc);
        const auto l2 = std::make_shared<pi::tensorlib::Linear>(
            "l2", 5, 2, device, dtype, pi::tensorlib::ActivationFunction::GELU, init_graph, rng_seed,
            main_stream_desc);
