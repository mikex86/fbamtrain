...
def main():
    ...
    x = torch.empty((BATCH, IN_CHANNELS, HEIGHT, WIDTH), dtype=dtype, device=device)
    fill_uniform_(x, INPUT_LOW, INPUT_HIGH, INPUT_SEED)
    ...
    weight = weight_hwio.permute(0, 3, 1, 2).contiguous()
